...
- `annotation/validation/human_gold_annotations.csv`: the stratified 30% human-consensus subset.
- `annotation/validation/llm_annotations_v1_combined.csv`: the LLM V1 annotations for all records.
...
This policy is reproduced in `results/rq1/rq1_annotation_policy.csv` and exported as `paper/tables/table_rq1c_annotation_policy.tex`.
