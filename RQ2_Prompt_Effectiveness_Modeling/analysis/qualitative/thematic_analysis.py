...
def run(root:Path):
    ...
    write_csv(out, root/"RQ2_Prompt_Effectiveness_Modeling/results/qualitative/thematic_summary.csv")
    (root/"RQ2_Prompt_Effectiveness_Modeling/results/qualitative/thematic_summary.md").write_text(out.to_markdown(index=False), encoding="utf-8")
    return out
