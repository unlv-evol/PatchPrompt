...
def run(root:Path):
    ...
    write_csv(out, root/"RQ2_Prompt_Effectiveness_Modeling/results/diagnostics/schoenfeld_residual_tests.csv"); write_latex_table(out, root/"RQ2_Prompt_Effectiveness_Modeling/results/tables_tex/schoenfeld_residual_tests.tex", "Schoenfeld residual diagnostics", "tab:schoenfeld"); return out
