...
def run(root:Path):
    ...
    out=pd.DataFrame(rows); write_csv(out, root/"RQ2_Prompt_Effectiveness_Modeling/results/diagnostics/separation_checks.csv"); write_latex_table(out, root/"RQ2_Prompt_Effectiveness_Modeling/results/tables_tex/separation_checks.tex", "Logistic separation screening", "tab:separation"); return out
