...
from RQ2_Prompt_Effectiveness_Modeling.analysis.common import load_analysis_dataset, write_csv, write_latex_table, safe_logit_fit
...
def run(root:Path):
    ...
    out=pd.DataFrame(rows); write_csv(out, root/"RQ2_Prompt_Effectiveness_Modeling/results/diagnostics/sensitivity_analysis.csv"); write_latex_table(out, root/"RQ2_Prompt_Effectiveness_Modeling/results/tables_tex/sensitivity_analysis.tex", "Robustness and sensitivity checks", "tab:sensitivity"); return out
