...
from RQ2_Prompt_Effectiveness_Modeling.analysis.common import load_analysis_dataset, write_csv, write_latex_table, stars
...
def run(root:Path):
    ...
    write_csv(out, root/"RQ2_Prompt_Effectiveness_Modeling/results/tables/gate2_integration_model.csv")
    write_latex_table(out[["Variable","Formatted"]], root/"RQ2_Prompt_Effectiveness_Modeling/results/tables_tex/gate2_integration_model.tex", "Gate 2: Fractional Logit Results for Fraction of Code Adopted", "tab:gate2")
    return out
