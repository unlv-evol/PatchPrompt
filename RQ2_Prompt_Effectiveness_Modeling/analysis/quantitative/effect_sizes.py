...
def run(root:Path):
    ...
    write_csv(out, root/"RQ2_Prompt_Effectiveness_Modeling/results/tables/effect_sizes.csv"); write_latex_table(out.round(3), root/"RQ2_Prompt_Effectiveness_Modeling/results/tables_tex/effect_sizes.tex", "Extended descriptive statistics", "tab:effect-sizes")
    return out
