...
paper/tables/table_rq1_*.tex
    LaTeX versions of the RQ1 tables.
...
def load_validation_data(root: Path) -> pd.DataFrame:
    ...
    human_path = root / "annotation" / "validation" / "human_gold_annotations.csv"
    llm_path = root / "annotation" / "validation" / "llm_annotations_v1_combined.csv"
...
def run(root: Path) -> dict[str, pd.DataFrame]:
    ...
    summary = (
        ...
        "This file is generated by `analysis/rq1/agreement_analysis.py`. It summarizes "
