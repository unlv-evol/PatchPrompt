...
def run(root:Path):
    ...
    out=pd.concat(rows, ignore_index=True); write_csv(out, root/"results/qualitative/code_frequencies.csv"); write_latex_table(out, root/"paper/tables/code_frequencies.tex", "Prompt-structure score frequencies by outcome class", "tab:code-frequencies"); return out
