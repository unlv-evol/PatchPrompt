...
def run(root:Path):
    ...
    write_csv(out, root/"results/qualitative/triangulation_summary.csv"); write_latex_table(out, root/"paper/tables/triangulation_summary.tex", "Integrated quantitative and qualitative interpretation", "tab:triangulation"); return out
