...
def run(root:Path):
    ...
    out=pd.DataFrame(rows); write_csv(out, root/"results/diagnostics/vif_results.csv"); write_latex_table(out.round(3), root/"paper/tables/vif_results.tex", "Variance inflation factor diagnostics", "tab:vif"); return out
