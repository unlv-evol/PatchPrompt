...
from analysis.common import ensure_dir, load_analysis_dataset
...
def _plot_vif_bar(root: Path) -> None:
    ...
    out_dir = ensure_dir(root / "results" / "diagnostics")
    vif_path = root / "results" / "diagnostics" / "vif_results.csv"
...
def _plot_schoenfeld_for_event(root: Path, event_col: str, label: str) -> None:
    ...
    """
    out_dir = ensure_dir(root / "results" / "diagnostics" / "schoenfeld_residual_plots")
