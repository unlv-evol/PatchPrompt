...
from RQ2_Prompt_Effectiveness_Modeling.analysis.descriptive import descriptive_statistics, appendix_b_descriptives
from RQ2_Prompt_Effectiveness_Modeling.analysis.quantitative import gate0_generation, gate1_adoption, gate2_integration, axisB_lifecycle, effect_sizes
from RQ2_Prompt_Effectiveness_Modeling.analysis.diagnostics import vif_analysis, separation_checks, schoenfeld_tests, sensitivity_analysis, robustness_sensitivity_outputs, diagnostic_plots_summary
from RQ2_Prompt_Effectiveness_Modeling.analysis.qualitative import code_frequency_analysis, thematic_analysis, triangulation_analysis, illustrative_examples
...
from RQ1_Prompt_Evaluation_Validation.analysis.rq1 import agreement_analysis
...
def reproduce_tables(root_or_results_dir: Path) -> None:
    ...
    write_csv(summary, root/"RQ2_Prompt_Effectiveness_Modeling/results/tables/table_1_summary.csv")
    write_latex_table(summary, root/"RQ2_Prompt_Effectiveness_Modeling/results/tables_tex/table_1_summary.tex", "Replication dataset summary", "tab:replication-summary")
    ...
    write_csv(combined, root/"RQ2_Prompt_Effectiveness_Modeling/results/tables/table_2_models.csv")
